/*
                Source: https://codeforces.com/contest/342/problem/E
 */
#include <bits/stdc++.h>
using namespace std;
...
int ans[MAXN]; //answer dp - smallest dist to red node
/*Preproccessing*/
...
/*queries*/
void update(int u) //change u to red, update all ans values above u
{
    int x = u;
    while(x != -1) {
