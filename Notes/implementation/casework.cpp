...
/*
                So many cases! In problems like these you have to split them up clearly and mentally do a full dfs search
                through all of them

                3 cases: case 2 has 2 subcases and case 3 has 3, total of 6 cases
 */
int main()
{
//    ofstream fout("f.out");
